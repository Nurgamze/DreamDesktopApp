...
class CiroTablosuPage extends StatefulWidget {
  final Size initialSize;
  const CiroTablosuPage({Key? key, required this.initialSize}) : super(key: key);

  @override
  State<CiroTablosuPage> createState() => _CiroTablosuPageState();
...
class _CiroTablosuPageState extends State<CiroTablosuPage> {
              ...
              child: Column(
                children: [
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            width: 290,
                            child: Text("Not: Kullanıcı yalnızca tam yetkili olduğu şubelerin cirolarını görebilir.",style: TextStyle(fontSize: 12),)
                          )
                        ],
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: Divider(color: Colors.black26,height: 9,),
                  )
                ],
              ),
            )
