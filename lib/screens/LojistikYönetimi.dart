...
class LojistikYonetimiPage extends StatefulWidget {
  final Size initialSize;
  const LojistikYonetimiPage({Key? key, required this.initialSize}) : super(key: key);

  @override
  State<LojistikYonetimiPage> createState() => _LojistikYonetimiPageState();
...
class _LojistikYonetimiPageState extends State<LojistikYonetimiPage> {
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(child: Text("EXTRE",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Column(
                          children: [
                            Container(
                              ...
                              child: Center(child: Text("AÇIK SİPARİŞLER",style: TextStyle(fontSize: 10),)),
                            ),SizedBox(height: 3,),
                            Container(
                              height: 20,
                              width: 80,
                              ...
                              child: Center(child: Text("ÖN SİPARİŞLER",style: TextStyle(fontSize: 10),)),
                            ),
                          ],
                        ),
                        SizedBox(width: 5,),
                        ...
                        Container(
                          ...
                          child: Center(child: Text(" NELER"+"\n SATTIK",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 45,
                          ...
                          child: Center(child: Text(" DÖNEMSEL "+"\n BAKİYELER",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 45,
                          ...
                          child: Center(child: Text("ADRESLER",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 45,
                        ...
                        Container(
                          ...
                          child: Center(child: Text("TAHSİLAT"+"\n  ÖZETİ",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 30,
                        ...
                        Container(
                          ...
                          child: Center(child: Text(" EXCEL'E"+"\n AKTAR",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 45,
