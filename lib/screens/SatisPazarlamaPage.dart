...
class SatisPazarlamaPage extends StatefulWidget {
  final Size initialSize;
  const SatisPazarlamaPage({Key? key, required this.initialSize}) : super(key: key);

  @override
  State<SatisPazarlamaPage> createState() => _SatisPazarlamaPageState();
...
class _SatisPazarlamaPageState extends State<SatisPazarlamaPage> {
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(child: Text(" TAHSİLAT"+"\n  LİSTESİ",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 35,
                        ...
                        Container(
                          ...
                          child: Center(child: Text("TAHSİLAT"+"\n  RAPORU",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 35,
                          ...
                          child: Center(child: Text("TAHSİLAT"+"\n  HEDEFLERİ",style: TextStyle(fontSize: 10),)),
                        ),
                        SizedBox(width: 5,),
                        Container(
                          height: 35,
